...
def bienvenida():
    print("*" * 68)
    print("* Te doy la bienvenida al juego del ahorcado de codigopython :) *")
    print("*" * 68)
...
def despedida():
    print("*" * 68)
    print("* Gracias por jugar al ahorcado de codigopython¡Hasta pronto! *")
    print("*" * 68)


if __name__ == "__main__":
    diccionario = ["casa", "muercielago", "calamar", "elefante", "codigopython"]
